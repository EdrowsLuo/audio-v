...
public abstract class ACanvas {
    ...
    /**
     * 通过反射创建的默认工厂，此时要求对应的ACanvas有对应的构造方法
     */
    public static class Factory extends AFactory {

        private Class<? extends ACanvas> klass;

        private Constructor<? extends ACanvas> constructor;

        public Factory(Class<? extends ACanvas> klass) throws NoSuchMethodException {
            this.klass = klass;
            this.constructor = klass.getConstructor(ATexture.class);
        }
